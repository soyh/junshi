...
from app.schemas.analysis_recommendation import AnalysisRecommendationContextResponse
...
router = APIRouter(
    prefix="/conversations/{conversation_id}/recommendation",
    tags=["recommendation"],
)
...
@router.get(
    "/context",
    response_model=AnalysisRecommendationContextResponse,
    status_code=status.HTTP_200_OK,
)
def get_analysis_recommendation_context(
    conversation_id: str,
