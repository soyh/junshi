...
from app.schemas.strategy_decision_learning_bridge import StrategyDecisionLearningBridgeSynthesisResponse
...
@router.get(
    "/synthesis",
    response_model=StrategyDecisionLearningBridgeSynthesisResponse,
    status_code=status.HTTP_200_OK,
)
def get_strategy_decision_learning_bridge_synthesis(
    person_id: str,
